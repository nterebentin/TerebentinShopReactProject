  ...
  useEffect(() => {
    ...
    const getAllCollectionsInfo = async () => {
        let response = await axios.get(
            'https://private-dfab49-nursenozcan.apiary-mock.com/Tahsilat'
            );
    
          //  console.log("getAllProductInfo" + response.data.TahsilatList);

            setAllCollections(response.data.TahsilatList);
    ...
    // call the function
    getAllCollectionsInfo().catch(console.error);
