  ...
  useEffect(() => {
    ...
    const getAllProductCategoryInfo = async () => {
        let response = await axios.get(
            'https://private-dfab49-nursenozcan.apiary-mock.com/UrunKategorisi'
            );
    
            //console.log("getAllProductCategoryInfo" + response.data.UrunKategorisiList);

            setAllProductCategory(response.data.UrunKategorisiList);
              ...
              <div className="portlet-body">
                <div className="table-responsive">
                  <table className="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        <td>1</td>
                        <td>{data.UrunKategorisiID}</td>
                        <td>{data.UrunKategorisi}</td>
                        <td>{data.AnaKategorisi}</td>
                      </tr>
                    </>
                    )
                    )
