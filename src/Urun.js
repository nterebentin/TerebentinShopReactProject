  ...
  useEffect(() => {
    ...
    const getAllProductsInfo = async () => {
        let response = await axios.get(
            'https://private-dfab49-nursenozcan.apiary-mock.com/Urun'
            );
    
          //  console.log("getAllProductInfo" + response.data.ProductsList);

            setAllProducts(response.data.ProductsList);
