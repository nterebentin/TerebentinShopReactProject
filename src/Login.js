...
function Login() {
  ...
  <div className="login">
        ...
        <div className="content">
          ...
          <form className="login-form">
            ...
            <div className="form-group">
              ...
              <input className="form-control form-control-solid placeholder-no-fix" type="text" autoComplete="off" placeholder="Username" name="username" onChange={e=>setName(e.target.value)} />
            </div>
            <div className="form-group">
              <label className="control-label visible-ie8 visible-ie9">Password</label>
              <input className="form-control form-control-solid placeholder-no-fix" type="password" autoComplete="off" placeholder="Password" name="password" onChange={e=>setPassword(e.target.value)} /> <br /><br />
            </div>
            <div className="form-actions">
              <a className="btn btn-success uppercase" onClick={()=>myButtonClick()}>Login</a>
              <label className="rememberme check">
                <input type="checkbox" name="remember" defaultValue={1} />Remember </label>
        ...
        <div className="copyright">
          2023 © Nterebentin. Admin Dashboard Template.
        </div>
        {/* END LOGIN */}
