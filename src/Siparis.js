  ...
  useEffect(() => {
    ...
    const getAllOrdersInfo = async () => {
        let response = await axios.get(
            'https://private-dfab49-nursenozcan.apiary-mock.com/Siparis'
            );
    
          //  console.log("getAllProductInfo" + response.data.SiparisList);

            setAllOrders(response.data.SiparisList);
